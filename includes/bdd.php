<?php
    ...
    try {
        $bdd = new PDO('mysql:host='.HOST.';dbname=tecnolha_gatadaarea;charset=utf8', 'tecnolha_gatadaarea', 'xX40028922');
...
?>
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="<?php echo PATH.'assets/css/style.css?3'; ?>">
        </head>
<?php
    }
    //-----------------------------------------------------------------------------------
