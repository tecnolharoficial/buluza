                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li><a href="<?php echo PATH.'publicar-anuncio/'; ?>" class="btn"><i class="fa-solid fa-circle-plus"></i> Públicar Anúncio</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
...
?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-center m-0">Copyright © 2023 <a href="#">Ask</a>. Todos os direitos reservados.</p>
                    </div>
                </div>
            </div>
        </footer>
